...
try {
    ...
    $kafka->consume(function($payload) {
        ...
        if(isset($payload['contactGroupId']) && $payload['contactGroupId'] > 0 && 1 == 2){
        ...
        // 2. send from contact list
        elseif(isset($payload['contacts']) && !empty($payload['contacts']) && count($payload['contacts']) > 0 && 1 == 2){
