...
CREATE TABLE adminroles (
  roleId TINYINT UNSIGNED NOT NULL AUTO_INCREMENT UNIQUE,
...
CREATE TABLE usersroles (
    ...
    FOREIGN KEY (roleId) REFERENCES adminroles (roleId) ON DELETE RESTRICT ON UPDATE RESTRICT,
    FOREIGN KEY (userId) REFERENCES users (userId) ON DELETE RESTRICT ON UPDATE RESTRICT,
    FOREIGN KEY (adminId) REFERENCES users (userId) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8;
