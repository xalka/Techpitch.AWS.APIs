...
class KafkaClient
{
    ...
    public function consumeMessages(string $topicName, string $groupId, callable $callback): void
    {
        ...
        // return $consumerTopic->consumeStart(RD_KAFKA_PARTITION_UA, RD_KAFKA_OFFSET_END); # to consume automatically from available partitions:
